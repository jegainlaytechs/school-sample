    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          {/* Desktop Right Phone Action */}
          <div className="hidden lg:flex items-center gap-3">
            <a
              href={`tel:${SCHOOL_DETAILS.mobile}`}
              className="bg-[#E86A33] hover:bg-[#D45823] text-white px-5 py-2.5 rounded-2xl font-bold text-sm shadow-md shadow-orange-500/20 hover:shadow-lg transition-all flex items-center gap-2"
            >
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-x-0 top-full bg-[#FAF5EE] border-b border-amber-900/10 shadow-2xl px-6 py-6 transition-all duration-300 animate-in fade-in slide-in-from-top-4">
          <div className="flex flex-col space-y-2">
            ...
            <div className="pt-4 border-t border-amber-900/10 flex items-center justify-around pt-2">
              <a
                href={`tel:${SCHOOL_DETAILS.mobile}`}
                className="text-xs font-semibold text-[#3D2314] flex items-center gap-1.5 py-2 px-4 rounded-xl bg-amber-100/60"
              >
              ...
              <a
                ...
                className="text-xs font-semibold text-emerald-800 flex items-center gap-1.5 py-2 px-4 rounded-xl bg-emerald-100/80"
              >
